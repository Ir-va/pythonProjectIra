    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(blank=True, help_text='Введите дату рождения', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ManyToManyField(help_text='Выберите атвора книги', null=True, to='catalog.author', verbose_name='Язык книги')),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inv_nom', models.CharField(help_text='Введите инветарный номер экземпляра', max_length=20, null=True, verbose_name='Инвентарный номер')),
                ...
                ('status', models.ForeignKey(help_text='Изменить состояние экземпляра', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='Стаус экземпляра книги')),
            ],
        ),
        migrations.AddField(
            model_name='book',
